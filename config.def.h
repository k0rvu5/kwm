...
/*static const char *fonts[]          = { "Terminus:size=9:style=Bold", "monospace:size=9" };*/
...
static const Key keys[] = {
  ...
  { MODKEY,                       XK_b,                    spawn,  SHCMD ("surf google.com")},
  /*{ MODKEY,                       XK_Print,                spawn,  SHCMD ("flameshot gui --clipboard")},*/
